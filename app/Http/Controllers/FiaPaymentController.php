                ...
                $query->orderBy('created_at', 'desc')->chunk(500, function($confirmations) use ($file, &$processedCount) {
                    foreach ($confirmations as $confirmation) {
                        ...
                        fputcsv($file, [
                            ...
                            $confirmation->paymentRecord ? number_format($confirmation->paymentRecord->gawio_la_fia ?? 0, 2) : '0.00',
                            $confirmation->paymentRecord ? number_format($confirmation->paymentRecord->fia_iliyokomaa ?? 0, 2) : '0.00',
                            $confirmation->paymentRecord ? number_format($confirmation->paymentRecord->jumla ?? 0, 2) : '0.00',
                            ...
                            $confirmation->paymentRecord ? number_format($confirmation->paymentRecord->kiasi_baki ?? 0, 2) : '0.00',
                            $paymentMethodText,
