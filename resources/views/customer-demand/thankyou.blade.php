...
<head>
    ...
    <title>Asante - Customer Demand Assessment - Dodoso</title>
            ...
            <div class="max-w-4xl mx-auto">
                ...
                <div class="text-center mb-12">
                    ...
                    <p class="font-lato text-xl text-gray-600 mb-8">
                        Umekamilisha kikamilifu fomu ya tathmini ya mahitaji ya wateja
                    </p>
                </div>
                    ...
                    <div class="max-w-2xl mx-auto">
                        <div class="mb-8">
                            ...
                            <h2 class="font-manrope text-2xl font-semibold text-gray-900 mb-4">
                                Data yako imehifadhiwa kikamilifu
                            </h2>
                            <p class="font-lato text-gray-600">
                                Jibu lako litatusaidia kuelewa mahitaji ya wateja na kuboresha huduma zetu
                            </p>
                        </div>
                    ...
                    <div class="glass-effect rounded-xl p-6">
                        ...
                        <div class="flex flex-col sm:flex-row justify-center items-center space-y-2 sm:space-y-0 sm:space-x-6">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-sm font-medium">info@dodoso.com</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
